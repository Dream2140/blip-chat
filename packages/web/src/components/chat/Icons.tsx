export const Icons = {
  ...
  Send: () => (
    <svg viewBox="0 0 24 24" fill="currentColor"><path d="M3.4 20.3 21 12 3.4 3.7 3.4 10l12 2-12 2z"/></svg>
  ),
  Paperclip: () => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  Pin: () => (
    <svg viewBox="0 0 24 24" fill="currentColor"><path d="M16 3a1 1 0 0 1 .7.3l4 4a1 1 0 0 1-.7 1.7h-2.2l-4.3 4.3.9 3.4a1 1 0 0 1-1.7.9L9 13.4l-5 5a1 1 0 0 1-1.4-1.4l5-5-4.2-4.2a1 1 0 0 1 .9-1.7l3.4.9L11.9 3h.1z"/></svg>
  ),
  Mic: () => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <rect x="9" y="2" width="6" height="12" rx="3" /><path d="M19 10a7 7 0 0 1-14 0M12 19v3" />
    </svg>
  ),
};
